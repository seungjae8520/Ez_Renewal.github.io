...
function selectService(service) {
    ...
    switch(service) {
        case 'mobile-transfer':
            window.location.href = './scroll-form/mobile-apply.html';
            break;
        case 'wireless-terminal':
            window.location.href = './scroll-form/wireless-terminal.html';
            break;
        case 'multi-tid':
            window.location.href = './scroll-form/multi-tid.html';
            break;
    }
}
